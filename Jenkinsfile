pipeline {
      ...
      environment{
         ...
         stage('copy the files') {
               steps {
               sh "scp -o StrictHostKeyChecking=no dev.yaml ec2-user@3.83.45.0:/home/ubuntu"
               sh "scp -o StrictHostKeyChecking=no deployans.yml ec2-user@3.83.45.0:/home/ubuntu"
               }
         }       
